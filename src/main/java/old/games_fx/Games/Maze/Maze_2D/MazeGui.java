...
import old.games_fx.Games.Maze.GameObserver;
import old.games_fx.Games.Maze.MazeGame;
import old.games_fx.KeybordListener.ArrowDirection;
import old.games_fx.KeybordListener.KeyboardListener;
import old.games_fx.KeybordListener.KeyObserver;
 ...
 * @author Elias
 */
public class MazeGui implements KeyObserver, GameObserver {
