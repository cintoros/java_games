...
import static old.games_swing.Games.g2048.g2048.Direction.*;
...
public class GameRulesTest {
    ...
    public void testFreeGrids0() throws Exception {
        ...
        assertEquals(0, r1.getFreeGridsCount(grid));
    }
    ...
    public void testFreeGrids16() throws Exception {
        ...
        assertEquals(16, r1.getFreeGridsCount(grid));
    }
    ...
    public void testComplex1() throws Exception {
        ...
        assertEquals(DOWN, r1.simulate(ArrayCopy.clone2DArray(grid)));
    }
}
